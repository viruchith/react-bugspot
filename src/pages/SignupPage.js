  ...
  return (
    <FormContainerComponent>
          ...
          <div className="mb-3">
            ...
            <input type="text"
              className="form-control" name="firstName" id="firstName" aria-describedby="helpId" placeholder=""/>
          ...
          <div className="p-3 mb-3">
            <span>Already have an account ? </span><span><Link to={"/login"}>Login</Link></span>
          </div>
        </form>
    </FormContainerComponent>
  )
